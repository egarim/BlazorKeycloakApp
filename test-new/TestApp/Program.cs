...
builder.Services.AddScoped<TestApp.Services.IApiService>(provider =>
{
    var httpClientFactory = provider.GetRequiredService<IHttpClientFactory>();
    var httpClient = httpClientFactory.CreateClient("ApiClient");
    var authService = provider.GetRequiredService<TestApp.Services.IAuthService>();
    var logger = provider.GetRequiredService<ILogger<TestApp.Services.ApiService>>();
    return new TestApp.Services.ApiService(httpClient, authService, logger);
});
...
builder.Services.AddScoped<TestApp.Services.IAuthService, TestApp.Services.AuthService>();
builder.Services.AddScoped<TestApp.Services.IApiDiagnosticsService>(provider =>
{
    var httpClientFactory = provider.GetRequiredService<IHttpClientFactory>();
    var httpClient = httpClientFactory.CreateClient("ApiClient");
    var authService = provider.GetRequiredService<TestApp.Services.IAuthService>();
    var configuration = provider.GetRequiredService<IConfiguration>();
    var logger = provider.GetRequiredService<ILogger<TestApp.Services.ApiDiagnosticsService>>();
    return new TestApp.Services.ApiDiagnosticsService(httpClient, authService, configuration, logger);
});
