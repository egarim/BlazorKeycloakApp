...
# REST API with Keycloak Template Packing Script
# Cross-platform PowerShell script to pack and install the template

param(
    [string]$TemplateDir = "BlazorApi",
...
Write-Host "   REST API with Keycloak Template " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$TemplateName = "RestApiWithKeyClock"
...
Write-Host "  dotnet new $TemplateShortName --name MyApi" -ForegroundColor White
Write-Host "  dotnet new $TemplateShortName --name MyApi --output ./MyApiProject" -ForegroundColor White
Write-Host "  dotnet new $TemplateShortName --name MyApi --AuthorityUrl `"http://localhost:8080/realms/my-realm`"" -ForegroundColor White
...
Write-Host "  mkdir test-api && cd test-api" -ForegroundColor White
Write-Host "  dotnet new $TemplateShortName --name TestApi" -ForegroundColor White
