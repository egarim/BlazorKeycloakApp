...
echo.
echo ========================================
echo   Blazor Server with Keycloak Template 
echo ========================================
echo.

set TEMPLATE_DIR=BlazorServer
set TEMPLATE_NAME=BlazorServerWithKeyClock
set OUTPUT_DIR=template-packages
set TEMPLATE_SHORT_NAME=blazorserverwithkeycloak
...
echo.
echo Usage Examples:
echo   dotnet new %TEMPLATE_SHORT_NAME% --name MyBlazorApp
echo   dotnet new %TEMPLATE_SHORT_NAME% --name MyBlazorApp --output ./MyBlazorProject
echo   dotnet new %TEMPLATE_SHORT_NAME% --name MyBlazorApp --AuthorityUrl "http://localhost:8080/realms/my-realm"
...
echo.
echo Quick Test:
echo   mkdir test-blazor
echo   cd test-blazor
echo   dotnet new %TEMPLATE_SHORT_NAME% --name TestBlazorApp
echo   dotnet run
echo.
